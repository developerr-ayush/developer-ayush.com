...
const RedirectAnchor = ({ href, redirectTitle, blank }: RedirectType) => {
    return (
        <Link href={href} className='redirect-anchor' target={blank ? "_blank" : "_self"} title={redirectTitle ? redirectTitle : href.split("/")[1]}>
