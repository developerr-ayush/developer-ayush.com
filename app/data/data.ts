import DataWeb from "@/assets/img/work/datawebDesktop.jpg";
import Cuvee from "@/assets/img/work/cuvee.jpg";
import GG from "@/assets/img/work/gg.jpg";
import Finexo from "@/assets/img/work/finexo.jpg";
import Wanderon from "@/assets/img/work/wanderon.jpg";
import Wireframe from "@/assets/img/work/wireframe.jpg";
...
let edu = [
  {
    ...
    data: "Took an extensive front-end web development course led by Rajdeep Dhakad at Hindi Tech Tutorials (Code Easy Academy). Throughout the course, I actively helped fellow students in their web development journey. This experience equipped me with the fundamentals of web development, and I learned a lot during this period of the course.",
  },
  {
    id: 2,
    ...
    date: "May 2021",
    data: "Successfully completed my Higher Secondary Certificate (HSC) from the Maharashtra Board in 2021, achieving 78%.",
  },
  {
    id: 3,
    from: "CodeEasyAcademy",
    ...
    data: "Participating in an advanced JavaScript course at Code Easy Academy to boost my JavaScript skills. Throughout the course, I've tackled various projects that required intricate JavaScript logic. Additionally, I've delved into advanced topics such as fetching APIs and handling errors on the front end, broadening my understanding and proficiency in JavaScript.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    data: "Successfully completed a Full Stack Development course at Apna College, where I gained expertise in the MERN stack. Throughout the course, I acquired valuable knowledge, covering topics such as login authorization, object-oriented programming (OOPs), and the backend workings. This learning experience has significantly enriched my skill set in full stack development.",
  },
  {
    id: 6,
    from: "Apna College",
    title: "Full Stack + DSA (Sigma Batch)",
    date: "June 2023 - December 2023",
    data: "Currently enrolled in the SIGMA batch at Apna College, where I am focusing on Data Structures and Algorithms (DSA). The program also includes web development, which seems somewhat familiar to what I've learned previously. However, I am confident in my ability to grasp DSA concepts, and I am particularly excited about working with Java in this context. Looking forward to enhancing my skills in these areas.",
  },
];
