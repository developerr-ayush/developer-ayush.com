...
export default function EditProductError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] text-center px-4">
      ...
      <h2 className="text-lg font-semibold text-gray-900 mb-1">Failed to load product</h2>
      <p className="text-sm text-gray-500 mb-4 max-w-md">
        {error.message || "Could not fetch this product. It may have been deleted or there's a database issue."}
      </p>
      {error.digest && (
